...
export const projects: Project[] = [
  {
    id: "project1",
    title: "Administrador de Tareas, Fullstack MERN",
    description: "Administrador de tareas full-stack desarrollado con MERN (MongoDB, Express, React, Node.js). Permite a los usuarios registrarse, iniciar sesión con JWT, restablecer su contraseña, crear proyectos y organizar tareas en estados: Pendiente, En Espera, En Progreso, En Revisión y Completado. Con un backend robusto conectado a MongoDB y un frontend interactivo en React, Uptask ofrece una experiencia completa de gestión de tareas, integrando autenticación segura, manejo de datos y control de estados de forma eficiente.",
    image: "uptask.png",
    tags: ["React", "MongoDB", "Express", "Node.js", "Tailwind CSS", "JavaScript", "HTML", "MERN", "JWT", "CRUD", "Autenticación", "Sesiones", "Consumo de API"],
    github: "https://github.com/JesusPineda29/MERN_backend_upTask",
    link: "https://mern-frontend-up-task.vercel.app"
  },
  {
    id: "project2",
    ...
    image: "pat.png",
    tags: ["Responsive Design", "React", "TypeScript", "Vite", "Tailwind CSS", "JavaScript", "HTML"],
  ...
  },
  {
    ...
    image: "MERN.png",
    tags: ["React", "MongoDB", "Express", "Node.js", "Tailwind CSS", "JavaScript", "HTML", "Responsive Design", "MERN", "JWT", "CRUD", "Autenticación", "Sesiones", "Consumo de API"],
...

  {
    ...
    image: "cripto.png",
    tags: ["React", "TypeScript", "Responsive Design", "Vite", "Zustand", "Zod", "Consumo de API", "HTML", "CSS", "JavaScript"],
...

  {
    ...
    image: "clima.png",
    tags: ["React", "TypeScript", "Vite", "HTML", "CSS Modules", "Responsive Design", "JavaScript", "Zod", "Consumo de API"],
...

  {
    ...
    image: "prestamo.png",
    tags: ["HTML", "CSS", "JavaScript", "Bootstrap", "React", "Vite", "Responsive Design"],
...

  {
    ...
    image: "festival.png",
    tags: ["HTML", "SCSS", "JavaScript", "Gulp", "Responsive Design"],

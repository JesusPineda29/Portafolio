        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-3">
            <div className="bg-gray-800 rounded-xl p-6 md:p-8 border border-gray-700">
              <h3 className="text-2xl font-bold text-white mb-6">Mandame un mensaje <span className='font-normal text-base text-gray-400'>- Aún no disponible (backend en desarrollo)</span> </h3>
              {submitResult && (
                <div className={`p-4 rounded-lg mb-6 ${submitResult.success ? 'bg-emerald-900/30 text-emerald-400' : 'bg-red-900/30 text-red-400'}`}>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label htmlFor="email" className="block text-gray-300 mb-2">Tu Correo Electronico</label>
                    <input
                      type="email"
                      id="email"
                      name="email"
